...
Devise.setup do |config|
  ...
  user_scopes = "read_mailbox,user_birthday,user_education_history,user_likes,user_location,user_relationships,user_status,user_religion_politics,user_photos,user_groups"
